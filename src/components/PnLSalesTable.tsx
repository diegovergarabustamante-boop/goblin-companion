    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '14px' }}>
        ...
        >
          ...
          />
          <div>
            <div style={{ fontSize: '0.75em', color: '#94a3b8', textTransform: 'uppercase', letterSpacing: '0.05em', fontWeight: 600 }}>
              Total Revenue
            </div>
            <div style={{ fontSize: '1.05em', marginTop: '2px' }}>
              <CoinBadge copper={totalRev} />
            </div>
          </div>
        </div>

        {/* Card 2: Total Investment / Cost */}
        <div
          className="glass-panel"
          style={{
            padding: '14px 18px',
        ...
        <div
          ...
          style={{
            ...
            background:
              totalProfit >= 0
                ? 'linear-gradient(135deg, rgba(52, 211, 153, 0.15) 0%, rgba(4, 120, 87, 0.25) 100%)'
                : 'linear-gradient(135deg, rgba(248, 113, 113, 0.15) 0%, rgba(153, 27, 27, 0.25) 100%)',
            border:
              totalProfit >= 0
        ...
        >
          <img
            src={totalProfit >= 0 ? '/images/goblin_assets/success.png' : '/images/goblin_assets/clear.png'}
            alt=""
          ...
          <div>
            ...
            <div style={{ fontSize: '1.05em', marginTop: '2px', color: totalProfit >= 0 ? '#4ade80' : '#f87171' }}>
              <CoinBadge copper={totalProfit} />
            </div>
          </div>
        </div>

        {/* Card 4: Items Sold Count */}
        <div
          className="glass-panel"
          style={{
            padding: '14px 18px',
            ...
            alignItems: 'center',
            gap: '12px',
            background: 'linear-gradient(135deg, rgba(168, 85, 247, 0.12) 0%, rgba(88, 28, 135, 0.2) 100%)',
        ...
        >
          ...
          <div>
            ...
            <div style={{ fontSize: '1.2em', fontWeight: 700, color: '#c084fc', marginTop: '2px' }}>
              {sales.length} items
            </div>
          </div>
        </div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '16px', marginBottom: '16px' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px', flex: 1, maxWidth: '380px' }}>
            <input
              ...
              style={{ padding: '8px 14px', fontSize: '0.88em', width: '100%' }}
            />
          </div>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            ...
            >
              <img
                src="/images/goblin_assets/sync.png"
                alt=""
                style={{ width: 16, height: 16, animation: loading ? 'spin 1s linear infinite' : 'none' }}
              />
              <span>Refresh</span>
            </button>
          </div>
