...
| 3. Watcher + sync | 2–3 | Auto/manual sync real a DB | **3a hecho** — watcher + sync lee `.lua` vía `/api/companion/read-saved-variable/`. **3b pendiente** — persistir inventario/accounting a DB |
